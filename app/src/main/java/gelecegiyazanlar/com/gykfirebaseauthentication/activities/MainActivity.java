...
import gelecegiyazanlar.com.gykfirebaseauthentication.fragments.MyNoteFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            editor.remove("result"); //yukarıdakileri yorum satırları haline getirdiğimizde yazdık
            editor.apply();
            editor.commit();
